...
void model_p3_pro_mini_flash_config_init(void)
{
  ...
  {
    //idex
    flash_param_t.idex_extruder_0_bed_offset[0] = 46;
    flash_param_t.idex_extruder_0_bed_offset[1] = 272;
    flash_param_t.idex_extruder_1_bed_offset[0] = 56;
    flash_param_t.idex_extruder_1_bed_offset[1] = 272;
    flash_param_t.idex_ext0_home_pos_adding[0] = 46;
    flash_param_t.idex_ext0_home_pos_adding[1] = 2;
    flash_param_t.idex_ext1_ext0_datum_pos[0] = 110.0f;
    flash_param_t.idex_ext1_ext0_datum_pos[1] = 10.0f;
    flash_param_t.idex_ext1_ext0_datum_pos[2] = 0.0f;
    //mix
    flash_param_t.mix_extruder_0_bed_offset[0] = 46;
    flash_param_t.mix_extruder_0_bed_offset[1] = 272;
    flash_param_t.mix_ext0_home_pos_adding[0] = 46;
    flash_param_t.mix_ext0_home_pos_adding[1] = 2;
    flash_param_t.mix_ext0_home_pos_adding[0] = 65;
    flash_param_t.mix_ext0_home_pos_adding[1] = 5;
    //laser
    flash_param_t.laser_extruder_0_bed_offset[0] = 46;
    flash_param_t.laser_extruder_0_bed_offset[1] = 272;
    flash_param_t.laser_extruder_1_bed_offset[0] = 56;
    flash_param_t.laser_extruder_1_bed_offset[1] = 272;
    flash_param_t.laser_ext0_home_pos_adding[0] = 46;
    flash_param_t.laser_ext0_home_pos_adding[1] = 2;
...
void model_p3_pro_mini_grbl_config_init(void)
{
  ...
  ccm_param.planner_settings.max_xy_jerk = 15.0f;
