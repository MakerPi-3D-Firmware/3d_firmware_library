...
#define APPLICATION_ADDRESS        ((uint32_t)0x08008400) //0x0800C000

/* Last Page Adress */
#define USER_FLASH_LAST_PAGE_ADDRESS  ((uint32_t)0x080FFFFF) //0x081FFFFF - 4
...
uint32_t FLASH_If_EraseSectors(uint32_t Address, uint32_t _LastPageAddress);
uint32_t FLASH_If_Write(uint32_t Address, uint32_t Data, uint32_t _LastPageAddress);
